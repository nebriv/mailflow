...
const en = {
  ...
  dryRun: {
    ...
    unclassified: '{{count}} messages predate the plugin and have never been classified.',
    classifyExisting: 'Classify existing mail',
...
const de = {
  ...
  dryRun: {
    ...
    unclassified: '{{count}} Nachrichten stammen von vor dem Plugin und wurden nie klassifiziert.',
    classifyExisting: 'Vorhandene Mail klassifizieren',
...
const fr = {
  ...
  dryRun: {
    ...
    unclassified: '{{count}} messages sont antérieurs au module et n’ont jamais été classés.',
    classifyExisting: 'Classer le courrier existant',
...
const es = {
  ...
  dryRun: {
    ...
    unclassified: '{{count}} mensajes son anteriores al complemento y nunca se han clasificado.',
    classifyExisting: 'Clasificar el correo existente',
...
const it = {
  ...
  dryRun: {
    ...
    unclassified: '{{count}} messaggi sono precedenti al plugin e non sono mai stati classificati.',
    classifyExisting: 'Classifica la posta esistente',
...
const ru = {
  ...
  dryRun: {
    ...
    unclassified: 'Писем старше плагина и ни разу не классифицированных: {{count}}.',
    classifyExisting: 'Классифицировать существующие письма',
...
const zhCN = {
  ...
  dryRun: {
    ...
    rows: '{{before}} 行 → {{after}}',
    nothing: '目前不会归类任何邮件。',
    unclassified: '有 {{count}} 封邮件早于本插件，从未被分类。',
    classifyExisting: '分类现有邮件',
    classifying: '正在分类…',
    refresh: '刷新',
  },
  noSubject: '（无主题）',
